...
public class SecurityConfig {
    ...
    static {
        securityPages.put(Role.ADMIN, Arrays.asList("/admin.jsp", "/admin", "/user", "/user.jsp", "/manager", "/manager.jsp", "/master", "/master.jsp", "/responses", "/responses.jsp", "/order", "/order.jsp"));
        securityPages.put(Role.CUSTOMER, Arrays.asList("/user",  "/user.jsp", "/responses", "/responses.jsp", "/order", "/order.jsp"));
