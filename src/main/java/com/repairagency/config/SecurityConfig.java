...
public class SecurityConfig {
    ...
    static {
        securityPages.put(Role.ADMIN, Arrays.asList("/admin", "/user", "/manager", "/master","/responses", "/order"));
        securityPages.put(Role.CUSTOMER, Arrays.asList("/user", "/responses", "/order"));
