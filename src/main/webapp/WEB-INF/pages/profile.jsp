              ...
              <div class="range">
                <div class="cell-sm-6">
                  <div class="form-group">
                    ...
                    <input id="contact-first-name" type="text" name="first-name" data-constraints="@Reqstaticred" class="form-control">
                  </div>
                </div>
                <div class="cell-sm-6 offset-top-18 offset-sm-top-0">
                  <div class="form-group">
                    ...
                    <input id="contact-last-name" type="text" name="last-name" data-constraints="@Reqstaticred" class="form-control">
                  </div>
                </div>
                <div class="cell-sm-6 offset-top-18">
                  <div class="form-group">
                    <label for="contact-email" class="form-label-outside"><fmt:message key="email"/></label>
                    <input id="contact-email" type="email" name="email" data-constraints="@Email @Reqstaticred" class="form-control">
                  </div>
                </div>
                <div class="cell-sm-6 offset-top-18">
                  <div class="form-group">
                    <label for="contact-phone" class="form-label-outside"><fmt:message key="phone"/></label>
                    <input id="contact-phone" type="text" name="phone" data-constraints="@Reqstaticred @Numeric" class="form-control">
                  </div>
                </div>
                <div class="cell-sm-6 offset-top-18">
                  <div class="form-group">
                    <label for="register-password" class="form-label-outside"><fmt:message key="password"/></label>
                        <input id="register-password" type="password" name="password" data-constraints="@Reqstaticred" class="form-control">
                  </div>
                </div>
                <div class="cell-sm-6 offset-top-18">
                  <div class="form-group">
                    <label for="register-confirm-password" class="form-label-outside"><fmt:message key="confirm.password"/></label>
                        <input id="register-confirm-password" type="password" name="password" data-constraints="@Reqstaticred" class="form-control">
                  </div>
                </div>
				</div>
