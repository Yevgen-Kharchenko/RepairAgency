                ...
                <div class="range">
                    <div class="cell-md-8">
                        <article class="post-single">
                            ...
                            <div class="post-body">
                                <figure class="post-image"><img src="static/images/blog-sidebar-2-770x510.jpg" alt="" width="770" height="510"/> </figure>
                                <div class="post-text">
                                ...
                                <figure class="post-image"><img src="static/images/blog-sidebar-1-770x510.jpg" alt="" width="770" height="510"/> </figure>
                                <div class="post-text">
                        ...
                        <div class="offset-top-60 offset-md-top-88">
                            ...
                            <article class="post-info">
                                <div class="unit unit-spacing-md unit-sm-horizontal">
                                    <div class="unit-left">
                                        <figure><img src="static/images/blog-post-3-170x170.jpg" alt="" width="170" height="170"/> </figure>
                                    </div>
                                    <div class="unit-body">
                                        <h6><a href="under-construction"><fmt:message key="benjamin.powell"/></a></h6>
                            ...
                            <div class="comment-group">
                                <article class="comment">
                                    <div class="comment-body">
                                        <div class="unit unit-spacing-sm unit-sm-horizontal">
                                            <div class="unit-left">
                                                <figure><img src="static/images/blog-post-4-70x70.jpg" alt="" width="70" height="70"/> </figure>
                                            </div>
                                            <div class="unit-body">
                                                <div class="comment-header">
                                                    <h6><a href="under-construction"><fmt:message key="stephanie.oliver"/></a></h6>
                                                    <time datetime="2016-04-24"><fmt:message key="april"/></time>
                                                </div>
                                                <div class="comment-text">
                                                    <p><fmt:message key="thanks.to"/></p>
                                                </div>
                                                <div class="comment-footer"><a href="under-construction" class="link link-icon link-primary"><span class="icon icon-xs fa-mail-reply"></span><span><fmt:message key="reply"/></span></a></div>
                                            </div>
                                        </div>
                                    </div>
                                </article>
                                <article class="comment comment-reply">
                                    <div class="comment-body">
                                        <div class="unit unit-spacing-sm unit-sm-horizontal">
                                            <div class="unit-left">
                                                <figure><img src="static/images/blog-post-5-70x70.jpg" alt="" width="70" height="70"/> </figure>
                                            </div>
                                            <div class="unit-body">
                                                <div class="comment-header">
                                                    <h6><a href="under-construction"><fmt:message key="benjamin.powell"/></a></h6>
